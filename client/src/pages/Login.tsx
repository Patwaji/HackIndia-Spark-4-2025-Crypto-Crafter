...
export default function Login() {
  ...
  const handleLoginWithReplit = () => handleAuthWindow("replit");
  const handleLoginWithGithub = () => handleAuthWindow("github");
  const handleLoginWithGoogle = () => handleAuthWindow("google");

  return (
    <div className="container mx-auto px-4 py-8">
      <Card className="max-w-md mx-auto p-6">
        <h1 className="text-2xl font-bold text-center mb-6">Log In to NutriPlan</h1>
        <div className="space-y-4">
          <p className="text-center text-gray-600">
            Log in to access your meal plans and nutrition data
          </p>
          <div className="space-y-4">
            <Button 
